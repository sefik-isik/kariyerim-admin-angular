...
@Component({
  ...
  templateUrl: './registerPersonelUser.component.html',
  styleUrls: ['./registerPersonelUser.component.css'],
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
})
export class RegisterPersonelUserComponent {
  title = 'Register Personel User';
